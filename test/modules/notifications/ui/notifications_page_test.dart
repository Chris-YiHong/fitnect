...
import 'package:fitnect/modules/notifications/ui/components/notification_tile.dart';
import 'package:fitnect/modules/notifications/ui/notifications_page.dart';
import 'package:fitnect/modules/notifications/ui/widgets/notification_tile.dart';
...
void main() {
  group('User is connected', () {
    testWidgets('Load notifications => should show 20 notifications', (
      tester,
    ) async {
