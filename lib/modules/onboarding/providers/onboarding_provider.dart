...
import 'package:fitnect/modules/onboarding/providers/onboarding_model.dart';
import 'package:fitnect/modules/onboarding/repositories/user_infos_repository.dart';
...
class OnboardingNotifier extends _$OnboardingNotifier {
  ...
  Future<void> onAnsweredQuestion(UserInfoDetail value) async {
    ...
    await userInfoRepository.save(userState.user.idOrThrow, value);
  }
