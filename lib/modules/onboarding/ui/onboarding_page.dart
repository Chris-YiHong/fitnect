...
import 'package:fitnect/modules/onboarding/ui/animations/page_transitions.dart';

import 'package:fitnect/modules/onboarding/ui/components/onboarding_features.dart';
import 'package:fitnect/modules/onboarding/ui/components/onboarding_loader.dart';
import 'package:fitnect/modules/onboarding/ui/components/onboarding_notifications_setup.dart';
import 'package:fitnect/modules/onboarding/ui/components/onboarding_questions.dart';
      ...
      onGenerateRoute:
          (settings) => switch (settings.name) {
            ...
            'sexe_question' => OnboardingRouteTransition(
              builder:
                  (context) => const UserSexeOnboardingQuestion(
            ...
            'age_question' => OnboardingRouteTransition(
              builder:
                  (context) => const UserAgeOnboardingQuestion(
