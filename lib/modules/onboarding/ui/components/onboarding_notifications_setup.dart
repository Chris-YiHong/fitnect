...
import 'package:fitnect/modules/onboarding/ui/widgets/onboarding_progress.dart';
...
class NotificationsPermissionStep extends ConsumerWidget {
  ...
  const NotificationsPermissionStep({super.key, required this.nextRoute});
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Center(
                      child: Image.asset('assets/images/onboarding/img2.jpg'),
                    ),
                  ),
                ),
                const Spacer(),
