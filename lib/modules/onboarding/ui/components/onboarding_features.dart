...
import 'package:fitnect/modules/onboarding/ui/widgets/onboarding_feature.dart';
import 'package:flutter/material.dart';

class OnboardingFeatureOne extends StatelessWidget {
  final String nextRoute;

  const OnboardingFeatureOne({super.key, required this.nextRoute});
...
class OnboardingFeatureTwo extends StatelessWidget {
  ...
  const OnboardingFeatureTwo({super.key, required this.nextRoute});
...
class OnboardingFeatureThree extends StatelessWidget {
  ...
  const OnboardingFeatureThree({super.key, required this.nextRoute});
