...
import 'package:fitnect/modules/onboarding/models/user_info.dart';
import 'package:fitnect/modules/onboarding/providers/onboarding_provider.dart';
import 'package:fitnect/modules/onboarding/ui/widgets/onboarding_radio_question.dart';
import 'package:fitnect/modules/onboarding/ui/widgets/selectable_row_tile.dart';
...
class UserSexeOnboardingQuestion extends ConsumerWidget {
  ...
  const UserSexeOnboardingQuestion({super.key, required this.nextRoute});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return OnboardingRadioQuestion(
      ...
      optionBuilder:
          (key, selected) => SelectableRowTile(
...
class UserAgeOnboardingQuestion extends ConsumerWidget {
  ...
  const UserAgeOnboardingQuestion({super.key, required this.nextRoute});
