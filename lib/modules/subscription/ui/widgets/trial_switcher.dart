      ...
      child: SwitchListTile(
        ...
        title: switch (_value) {
          false => Text(
            Translations.of(
              context,
            ).paywallWithSwitch.noTrial.trial_switch_title,
            style: context.textTheme.bodySmall?.copyWith(
              color: context.colors.background,
            ),
          ),
          true => Text(
            Translations.of(context).paywallWithSwitch.withTrial
                .trial_switch_title(days: widget.trialDays),
        ...
        subtitle: switch (_value) {
          false => Text(
            Translations.of(
              context,
            ).paywallWithSwitch.noTrial.trial_switch_subtitle,
            style: context.textTheme.bodyLarge?.copyWith(
              color: context.colors.background,
              fontWeight: FontWeight.w700,
            ),
