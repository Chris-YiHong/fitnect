...
import 'package:fitnect/modules/subscription/ui/component/premium_page_factory.dart';
import 'package:fitnect/modules/subscription/ui/widgets/premium_background_gradient.dart';
import 'package:fitnect/modules/subscription/ui/widgets/premium_close_button.dart';
import 'package:fitnect/modules/subscription/ui/widgets/premium_feature.dart';
import 'package:fitnect/modules/subscription/ui/widgets/selectable_row.dart';
import 'package:fitnect/modules/subscription/ui/widgets/trial_switcher.dart';
...
class PaywallWithSwitch extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (selectedOfferTrialDays > 0) {
      ...
      title = translations.withTrial.title(days: selectedOfferTrialDays);
    } else {
...
class PremiumSecondaryButton extends ConsumerWidget {
  ...
  const PremiumSecondaryButton({super.key, this.onTap, required this.title});
