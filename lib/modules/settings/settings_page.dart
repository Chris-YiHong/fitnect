...
import 'package:fitnect/modules/settings/ui/components/avatar_component.dart';
import 'package:fitnect/modules/settings/ui/components/delete_user_component.dart';
import 'package:fitnect/modules/settings/ui/widgets/settings_tile.dart';
                ...
                children: [
                  ...
                  SettingsTile(
                    ...
                    onTap: () {
                      ...
                      launchUrl(Uri.parse("https://fitnect.dev/privacy/"));
                    },
                  ),
                  Divider(color: Colors.blueGrey.withValues(alpha: .10)),
                  SettingsTile(
                    ...
                    onTap: () {
                      // you may need to add some url_launcher configuration in your app for iOS and Android
                      // https://pub.dev/packages/url_launcher
                      launchUrl(Uri.parse("https://fitnect.dev/"));
                    },
                  ),
                  Divider(color: Colors.blueGrey.withValues(alpha: .10)),
                  SettingsTile(
