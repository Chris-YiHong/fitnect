...
import 'package:fitnect/core/theme/providers/fitnect_theme.dart';
...
class AppTheme with ChangeNotifier {
  final FitNectTheme? lightTheme;
  final FitNectTheme? darkTheme;
  ...
  factory AppTheme.uniform({
    FitNectColors? lightColors,
    FitNectColors? darkColors,
    required FitNectTextTheme textTheme,
    required FitNectThemeDataFactory themeFactory,
  ...
  factory AppTheme.adaptive({
    ...
    required FitNectTextTheme defaultTextTheme,
    required ThemeMode mode,
    FitNectColors? lightColors,
    FitNectColors? darkColors,
    FitNectThemeDataFactory? ios,
    FitNectThemeDataFactory? android,
    FitNectThemeDataFactory? web,
  }) {
    return AppTheme(
      mode: mode,
      sharedPreferences: sharedPreferences,
