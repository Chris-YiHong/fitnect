...
final remoteConfigApiProvider = Provider<RemoteConfigApi>((ref) {
...
class RemoteConfigWrapper {
  ...
  RemoteConfigWrapper({required FirebaseRemoteConfig remoteConfig})
    : _remoteConfig = remoteConfig;
...
abstract class RemoteConfigData<T> {
  ...
  RemoteConfigData({required this.key});
...
class SubscriptionConfigs {
  ...
  SubscriptionConfigs({required this.title});
}
