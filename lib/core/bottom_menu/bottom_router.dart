...
import 'package:fitnect/core/bottom_menu/notification_bottom_item.dart';
import 'package:fitnect/core/rating/widgets/rate_banner.dart';
import 'package:fitnect/core/theme/extensions/theme_extension.dart';
import 'package:fitnect/modules/home/home_page.dart';
import 'package:fitnect/modules/notifications/ui/notifications_page.dart';
import 'package:fitnect/modules/settings/settings_page.dart';
...
List<BartMenuRoute> subRoutes() {
  return [
    ...
    BartMenuRoute.bottomBarBuilder(
      label: "Notifications",
      builder: (_, isActive) => NotificationBottomItem(isActive: isActive),
      path: 'notifications',
      ...
      child: Container(
        ...
        child: const Column(
          children: [
            ...
            SizedBox(height: 100),
            Opacity(opacity: 0.5, child: Text("This is a fake page")),
          ],
        ),
      ),
    );
