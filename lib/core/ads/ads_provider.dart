...
import 'package:fitnect/core/ads/ads_state.dart';
...
final googleAdsProvider = StateNotifierProvider<GoogleAdsProvider, AdState>(
  (ref) => GoogleAdsProvider(environment: ref.watch(environmentProvider)),
);
...
class GoogleAdsProvider extends StateNotifier<AdState> {
  ...
  GoogleAdsProvider({required this.environment}) : super(const AdState());
